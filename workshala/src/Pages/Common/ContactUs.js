...
export default function ContactUs() {
    ...
    >
      ...
      <Grid container spacing={3}>
            <Grid item md={12}>
              <Typography variant="h3" component="h3" textAlign={"center"} style={{fontWeight:800}}>
                Contact Us
            </Typography>
          </Grid>
          <Grid item md={12}>
          ...
          <Grid item container direction="column" md={3.5} sx={{ml:5}} alignContent={"center"}>
            ...
            <Grid item container direction="column" md={4} alignContent={"center"}>
            <Grid item alignSelf={"center"}>
                <PhoneIphoneIcon/>
            </Grid>
            <Grid item>
            ...
            <Button variant="contained" sx={{p:5, width:"10px"}} component={Link} to="/">
                Back to Home
                </Button>
            </Grid>
            </Grid>
