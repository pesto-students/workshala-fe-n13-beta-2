...
import {Avatar, CardActions,
 CardContent, Card, CardActionArea} from "@mui/material";
...
export default function Home() {
  ...
  return (
    <Grid container>
      ...
      {isEmpty(searchData) ? 
        <Footer /> :
        <Box sx={{ float: "center", border:1, backgroundColor:"floralwhite", p:2, borderRadius:8}}>
          <Typography variant="h5" style={{}} color="text.primary" sx={{p:2}}>
