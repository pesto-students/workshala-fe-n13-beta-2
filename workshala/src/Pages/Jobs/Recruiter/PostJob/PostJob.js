            ...
            <Grid item container md={6} spacing={5}>
              ...
              <Grid item md={6} textAlign={"left"}>
                <TextField
                  id={"Position"}
                  fullWidth
                  {...register("position", { required: true, maxLength: 30 })}
                ></TextField>
              </Grid>
            </Grid>
          </Grid>
            ...
            <Grid item container md={6} spacing={3.5}>
              ...
              <Grid item md={6}>
                <TextField
                  id={"workLevel"}
                  fullWidth
                  {...register("workLevel", { required: true, maxLength: 30 })}
                ></TextField>
              </Grid>
            </Grid>
            <Grid item container md={6} spacing={5}>
          ...
          <Grid item container key={i} md={12} spacing={2}>
            ...
            <Grid item md={9}>
              <TextField
                ...
                {...register(item.value, { required: true, maxLength: 30 })}
              ></TextField>
            </Grid>
          </Grid>
        ))}
            ...
            <Grid item container md={6} spacing={3.5}>
              ...
              <Grid item md={6}>
                <TextField
                  id={"maxSalary"}
                  fullWidth
                  {...register("maxSalary", { required: true, maxLength: 30 })}
                ></TextField>
              </Grid>
            </Grid>
            <Grid item container md={6} spacing={5}>
              ...
              <Grid item md={6} textAlign={"left"}>
                <TextField
                  id={"minSalary"}
                  fullWidth
                  {...register("minSalary", { required: true, maxLength: 30 })}
                ></TextField>
              </Grid>
            </Grid>
          </Grid>
        ...
        <Grid item container md={12} spacing={2}>
          ...
          <Grid item md={7.5} textAlign={"left"}>
            <TextField
              id="qualification"
              fullWidth
              {...register("qualification", { required: true, maxLength: 30 })}
              multiline
              rows={4}
            ></TextField>
          </Grid>
    ...
    <FormProvider {...methods}>
      <form onSubmit={handleSubmit(onSubmit)}>
        <Grid container spacing={1}>
          ...
          <Grid item md={6}>
            <Button variant="contained" component={Link} to="/recruiter/jobs">
              Cancel
            </Button>
          </Grid>
        </Grid>
