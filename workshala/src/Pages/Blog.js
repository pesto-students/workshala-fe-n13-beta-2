...
const CardData = [
  ...
  },
  {
    img: blog_3,
    title: "",
    text: "A job board is a type of employment website that serves job ads posted by employers. Job boards can be general or focus on a specific industry like IT, retail, healthcare, or hospitality. Job sites connect employers with potential employees by aggregating listings for open positions.",
  ...
  },
  {
    ...
    contentTitle: "Work from home during pandemic",
    contentText: "",
  },
  {
    img: blog_5,
    ...
    contentTitle: "Role of AI in Job Search & Recruiting",
    contentText: "",
  },
];
const CardTemplate = (props) => {
  return (
    <Card>
      <CardActionArea>
        <CardMedia component="img" height="40%" image={props.img} alt="blog" />
        <CardContent>
